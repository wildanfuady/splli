    ...
    <div class="row pt-3">
        ...
        <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
                ...
                <a href="{{ route('barangs.index') }}" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
                ...
                <a href="{{ route('uangKeluars.index') }}" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
                ...
                <a href="{{ route('uangDiluars.index') }}" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
